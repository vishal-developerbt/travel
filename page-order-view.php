        ...
        <!-- <div class="row mb-3">
            <div class="col-md-12">
                ...
                <ul class="list-unstyled mb-0">
                    <?php
                    // $passengers = $flightDetail['ItineraryInfo']['CustomerInfos'] ?? [];
                    // foreach ($passengers as $pax) {
                    //     $info = $pax['CustomerInfo'];
                    //     $name = $info['PassengerTitle'] . ' ' . $info['PassengerFirstName'] . ' ' . $info['PassengerLastName'];
                    //     $type = $info['PassengerType'];
                    //     echo '<li>' . esc_html($name . ' (' . $type . ') - ' . $info['eTicketNumber']) . '</li>';
                    // }
                    ?>
                </ul>
            </div>
